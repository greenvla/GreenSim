...
@configclass
class ExampleActionsCfg:
    legs_joint_pos = mdp.JointEffortActionCfg(    #mdp.JointPositionActionCfg(
    ...
    torso_joint_pos = mdp.JointEffortActionCfg(    #mdp.JointPositionActionCfg(
        asset_name="robot",  # Must match your robot asset name
        joint_names=[
            # Regex to select arm joints
             "torso_yaw_joint",
